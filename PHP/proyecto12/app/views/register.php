...
<div class="card p-4 bg-light">
    ...
    <div class="card-body">
        <form action="<?= ROOT ?>login/registro/" method="post">
            ...
            <div class="form-group text-left">
                <label for="password_1">Clave de acceso:</label>
                <input type="password_1" name="password_1" id="password_1" class="form-control"
                       required placeholder="Escriba su contraseña"
                >
            </div>
            <div class="form-group text-left">
                <label for="password_2">Repita su clave de acceso:</label>
                <input type="password_2" name="password_2" id="password_2" class="form-control"
